...
def create_test_data():
    ...
    db.teams.add_user_to_team(connection, 4, 1)  # add player 2 to team 1
    db.teams.add_user_to_team(connection, 5, 1)  # add player 3 to team 1
    db.teams.add_user_to_team(connection, 6, 1)  # add player 4 to team 1
    db.teams.add_user_to_team(connection, 7, 1)  # add player 5 to team 1
    db.teams.add_user_to_team(connection, 8, 1)  # add player 6 to team 1
    db.teams.add_user_to_team(connection, 9, 1)  # add player 7 to team 1
    db.teams.add_user_to_team(connection, 3, 2)  # add player 1 to team 2
    db.teams.add_user_to_team(connection, 4, 2)  # add player 2 to team 2
    db.teams.add_user_to_team(connection, 8, 2)  # add player 6 to team 2
    db.teams.add_user_to_team(connection, 9, 2)  # add player 7 to team 2
    db.teams.add_user_to_team(connection, 10, 2)  # add player 8 to team 2
    db.teams.add_user_to_team(connection, 11, 2)  # add player 9 to team 2
    db.teams.add_user_to_team(connection, 12, 2)  # add player 10 to team 2
...
@testbp.route('/test')
def test():
    result = db.messages.get_groups_messages(connection, 3)
